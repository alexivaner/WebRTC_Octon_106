...
import org.imediawebrtc.VideoDecoder.DecodeInfo;
import org.imediawebrtc.VideoFrame.I420Buffer;
import org.imediawebrtc.VideoFrame.TextureBuffer.Type;
  ...
  private class TestDecoderBuilder {
    ...
    public TestDecoder build() {
      return new TestDecoder((String name)
          ...
          /* codecName= */ "org.imediawebrtc.testdecoder", codecType, COLOR_FORMAT,
