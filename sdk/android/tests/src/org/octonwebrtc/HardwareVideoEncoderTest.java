...
import org.octonwebrtc.EncodedImage;
import org.octonwebrtc.EncodedImage.FrameType;
import org.octonwebrtc.FakeMediaCodecWrapper.State;
import org.octonwebrtc.VideoCodecStatus;
import org.octonwebrtc.VideoEncoder;
import org.octonwebrtc.VideoEncoder.BitrateAllocation;
import org.octonwebrtc.VideoEncoder.CodecSpecificInfo;
import org.octonwebrtc.VideoEncoder.EncodeInfo;
import org.octonwebrtc.VideoEncoder.Settings;
import org.octonwebrtc.VideoFrame;
import org.octonwebrtc.VideoFrame.Buffer;
import org.octonwebrtc.VideoFrame.I420Buffer;
  ...
  private class TestEncoderBuilder {
    ...
    public TestEncoder build() {
      return new TestEncoder((String name)
          ...
          "org.octonwebrtc.testencoder", codecType,
