...
+ (void)initialize {
  ...
  dispatch_once(&onceToken, ^{
    kAudioSessionQueue = dispatch_queue_create(
        "org.octonwebrtc.RTCDispatcherAudioSession",
        DISPATCH_QUEUE_SERIAL);
    kCaptureSessionQueue = dispatch_queue_create(
        "org.octonwebrtc.RTCDispatcherCaptureSession",
        DISPATCH_QUEUE_SERIAL);
    kNetworkMonitorQueue =
        dispatch_queue_create("org.octonwebrtc.RTCDispatcherNetworkMonitor", DISPATCH_QUEUE_SERIAL);
  });
}
