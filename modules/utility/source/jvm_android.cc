...
struct {
  ...
  jclass clazz;
    ...
    {"org/octonwebrtc/voiceengine/BuildInfo", nullptr},
    {"org/octonwebrtc/voiceengine/WebRtcAudioManager", nullptr},
    {"org/octonwebrtc/voiceengine/WebRtcAudioRecord", nullptr},
    {"org/octonwebrtc/voiceengine/WebRtcAudioTrack", nullptr},
};
...
void JVM::Initialize(JavaVM* jvm, jobject context) {
  ...
  jclass context_utils = FindClass(jni, "org/octonwebrtc/ContextUtils");
