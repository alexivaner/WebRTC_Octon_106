...
struct {
  ...
  jclass clazz;
    ...
    {"org/imediawebrtc/voiceengine/BuildInfo", nullptr},
    {"org/imediawebrtc/voiceengine/WebRtcAudioManager", nullptr},
    {"org/imediawebrtc/voiceengine/WebRtcAudioRecord", nullptr},
    {"org/imediawebrtc/voiceengine/WebRtcAudioTrack", nullptr},
};
...
void JVM::Initialize(JavaVM* jvm, jobject context) {
  ...
  jclass context_utils = FindClass(jni, "org/imediawebrtc/ContextUtils");
